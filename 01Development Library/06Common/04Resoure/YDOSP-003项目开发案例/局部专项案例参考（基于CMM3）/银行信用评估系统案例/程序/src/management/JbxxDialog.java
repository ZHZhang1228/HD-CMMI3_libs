...
*/
  ...
  private void jbInit() throws Exception {
    ...
    jComboBox9.addItem("");
    jComboBox9.addItem("5年以上");
     jComboBox9.addItem("3-5年");
     jComboBox9.addItem("1-3年");
     jComboBox9.addItem("1年以内");

     jComboBox13.addItem("");
     jComboBox13.addItem("5000元以上");
      jComboBox13.addItem("3000-5000元");
      jComboBox13.addItem("2000-3000元");
      jComboBox13.addItem("1000-2000元");
       jComboBox13.addItem("500-1000元");
        jComboBox13.addItem("500元以下");

        jComboBox7.addItem("");
    jComboBox7.addItem("厅局级以上");
    jComboBox7.addItem("处级");
    jComboBox7.addItem("科级");
    jComboBox7.addItem("一般机关干部");
    jComboBox7.addItem("其他机关员工");
    jComboBox7.addItem("正副总经理");
    jComboBox7.addItem("部门经理");
    jComboBox7.addItem("一般企业干部");
    jComboBox7.addItem("其他企业员工");

    jComboBox3.addItem("");
    jComboBox3.addItem("公务员");
    jComboBox3.addItem("教师、医生、");
    jComboBox3.addItem("金融、律师");
     jComboBox3.addItem("军人、记者");
    jComboBox3.addItem("企业主、公司职员");
     jComboBox3.addItem("其它职业");
   ...
   jComboBox12.addItem("定期以及银行卡");
    jComboBox12.addItem("定期");
    jComboBox12.addItem("银行卡");
    jComboBox12.addItem("仅开立活期存折帐户");
     jComboBox12.addItem("无帐户");

     jComboBox1.addItem("");
    jComboBox1.addItem("研究生生以上");
    jComboBox1.addItem("本科");
    jComboBox1.addItem("大专");
    jComboBox1.addItem("高中，中专");
    jComboBox1.addItem("其他");

    jComboBox4.addItem("");
    jComboBox4.addItem("已婚有子女");
    jComboBox4.addItem("已婚无子女");
    jComboBox4.addItem("未婚");
    jComboBox4.addItem("其他");

    jComboBox14.addItem("");
    jComboBox14.addItem("密切");
    jComboBox14.addItem("一般");
    jComboBox14.addItem("较少");

    jComboBox16.addItem("");
    jComboBox16.addItem("有借款已还清");
    jComboBox16.addItem("有逾期记录");
    jComboBox16.addItem("从未借款");
    jComboBox16.addItem("曾还款，但尚有借款");
    jComboBox16.addItem("不曾还款，但尚有借款");

    jComboBox8.addItem("");
    jComboBox8.addItem("高级");
    jComboBox8.addItem("中级");
    jComboBox8.addItem("初级");
    jComboBox8.addItem("无");

    jComboBox11.addItem("");
    jComboBox11.addItem("自有住房");
    jComboBox11.addItem("贷款购房");
    jComboBox11.addItem("租用公房");
    jComboBox11.addItem("其他");

    jComboBox5.addItem("");
    jComboBox5.addItem("常住户口");
    jComboBox5.addItem("临时户口");

    jComboBox10.addItem("");
    jComboBox10.addItem("500元以下");
    jComboBox10.addItem("500-1000元");
    jComboBox10.addItem("1000-3000元");
    jComboBox10.addItem("3000元以上");

    jComboBox17.addItem("");
    jComboBox17.addItem("10000元以上");
    jComboBox17.addItem("8000-10000元");
    jComboBox17.addItem("5000-8000元");
    jComboBox17.addItem("4000-5000元 ");
    jComboBox17.addItem("3000-4000元");
    jComboBox17.addItem("2000-3000元");
    jComboBox17.addItem("1000-2000元");
    jComboBox17.addItem("1000元以下");

    jComboBox18.addItem("");
    jComboBox18.addItem("是");
    jComboBox18.addItem("否");
  ...
  // String SQL = "Insert Into Users(UserName,UserCard,YHworkerID,UserSex) Values("+"\'"+jTextField1.getText() +"\'"+ ","+"\'"+jTextField2.getText() +"\'"+","+"\'"+intYHworkerID +"\'"+","+"\'"+(String)jComboBox2.getSelectedItem()+"\'"+")";
   ...
   {
        CheckDialog CheckDialog3=new CheckDialog("请正确填写所有资料！");
...
if(myflag!=9)
{
    ...
    stmt23.executeUpdate(SQL23);
     ...
     //写入工作情况表
     String query5 = "select * from Profession  ";  //获得用户职业情况，即上面刚写入的最户一条记录
     ...
     if(myflag!=9)
{
     ...
     CheckDialog CheckDialogSuccess=new CheckDialog("用户办卡成功！ ","用户帐号：         "+ newUID ,"用户信用卡号： "+ newCardID,"用户初始密码:    000000  ");
   ...
   {
     CheckDialog CheckDialogSuccess=new CheckDialog("用户办卡成功！ ","用户帐号：         "+ newUID ," ","  ");
   CheckDialogSuccess.setBounds(300,200,300,200);
   CheckDialogSuccess.show();
    ...
    {
         eee.printStackTrace();
         CheckDialog CheckDialog3=new CheckDialog("填写错误！请正确填写各个选项！");
         CheckDialog3.setBounds(300,200,300,200);
         CheckDialog3.show();
