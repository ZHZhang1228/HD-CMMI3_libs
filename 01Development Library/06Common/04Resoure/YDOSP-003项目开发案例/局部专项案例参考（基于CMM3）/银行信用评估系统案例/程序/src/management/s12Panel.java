  ...
  void jButton1_actionPerformed(ActionEvent e) {
    try{
      if(jTextField1.getText().length()==0){
        JOptionPane.showMessageDialog(this,"信用卡号不能为空！","警告",JOptionPane.WARNING_MESSAGE);
      ...
      if(s12rs.next()){
        ...
        if(s12rs.next()){
          ...
          JOptionPane.showMessageDialog(this,"系统出错，请重新输入！","错误",JOptionPane.WARNING_MESSAGE);
        ...
        if(s12rs2.next()){
          ...
          islie=false;
          JOptionPane.showMessageDialog(this,"该用户尚无抵押物，请为其设置新的抵押物编号！","通知",JOptionPane.WARNING_MESSAGE);
          int y=java.util.Calendar.getInstance().get(java.util.Calendar.YEAR);
          int m=java.util.Calendar.getInstance().get(java.util.Calendar.MONTH)+1;
          int d= java.util.Calendar.getInstance().get( java.util.Calendar.DATE);
          String dd=String.valueOf(y)+"-"+String.valueOf(m)+"-"+String.valueOf(d);
        ...
        JOptionPane.showMessageDialog(this,"信用卡号或密码错误！","警告",JOptionPane.ERROR_MESSAGE);
      //set focus
        return;
      }
  ...
  void jButton4_actionPerformed(ActionEvent e) {
    try{
      if(jTextField5.getText().length()==0){
        JOptionPane.showMessageDialog(this,"抵押物编号不能为空！","警告",JOptionPane.WARNING_MESSAGE);
        //set focus
        return;
      }
      else if(jTextField2.getText().length()==0){
        JOptionPane.showMessageDialog(this,"抵押物名称不能为空！","警告",JOptionPane.WARNING_MESSAGE);
        //set focus
        return;
      }
      else if(jTextField3.getText().length()==0){
        JOptionPane.showMessageDialog(this,"日期不能为空！","警告",JOptionPane.WARNING_MESSAGE);
        //set focus
        return;
      }
      if(islie==false)
      ...
      switch(zvariety){
        case 0 :
          ...
          s12stmt1.executeUpdate();
          JOptionPane.showMessageDialog(this,"调整成功\n"+"信用等级已调整为： "+cGrade+"\n信用额度已调整为： "+getmoney(cGrade.toCharArray()[0])+" 元","通知",JOptionPane.INFORMATION_MESSAGE);
          setempty();
          break;
        case 1 :
          countCGrade(dmoney);
    ...
    }catch(SQLException ee){//数据库出错
      JOptionPane.showMessageDialog(this,"数据库出错，请检查！","错误",JOptionPane.ERROR_MESSAGE);
    }
    catch(Exception ep){//以外错误
      String errmsg=ep.getMessage();
      System.out.println(errmsg);
      JOptionPane.showMessageDialog(this,"意外错误","错误",JOptionPane.ERROR_MESSAGE);
    }
  }
